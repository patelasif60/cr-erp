    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="javascript:void(0)" id="add_manufacturer_form" >
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" name="unit" placesholder=" enter unit" id="unit" style="width:100%;"/> 
            </div> 
            <div class="modal-body">
                <label for="abbreviation">Abbreviation</label>
                <input type="text" class="form-control" name="abbreviation" placesholder=" enter abbreviation" id="abbreviation" style="width:100%;"/> 
