    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="javascript:void(0)" id="add_manufacturer_form" >
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" name="unit_description" placesholder="enter unit description" id="unit_description" style="width:100%;"/> 
            </div> 
...
$("#add_manufacturer_form").validate({
    submitHandler(form){
        ...
        $.ajax({
            type: "POST",
            url: '{{route('unit_description.store')}}',
            data: form1, 
            processData: false,
            contentType: false,
