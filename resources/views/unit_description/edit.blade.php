    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="javascript:void(0)" id="edit_manufacturer_form" >
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" name="unit_description" placesholder="Edit unit description" id="unit_description" style="width:100%;" value="{{ $row['unit_description'] }}"/> 
            </div> 
...
$("#edit_manufacturer_form").validate({
    submitHandler(form){
        ...
        $.ajax({
            type: "POST",
            url: '{{route('unit_description.update',$row['id'])}}',
            data: form1, 
            processData: false,
            contentType: false,
