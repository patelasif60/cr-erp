    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="javascript:void(0)" id="add_manufacturer_form" >
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" name="product_temperature" placesholder="Add new product temperature" id="product_temperature" style="width:100%;"/> 
            </div> 
...
$("#add_manufacturer_form").validate({
    submitHandler(form){
        ...
        $.ajax({
            type: "POST",
            url: '{{route('product_temperature.store')}}',
            data: form1, 
            processData: false,
            contentType: false,
