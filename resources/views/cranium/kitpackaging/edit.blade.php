        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                ...
                <form method="POST"  id="packaging_material_form">
                	@csrf
                	<input type="hidden" name="supplier_id" value="{{$packagingMatirials->supplier_id}}">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="ETIN" name="ETIN" placeholder="ETIN" value='{{$packagingMatirials->ETIN}}' readonly>
                                    </div>
                                    <div class="form-group col-md-12">
	                                    <label for="description" class="ul-form__label">Product Description:<span class="text-danger">*</span></label>
	                                    <textarea required name="product_description" id="product_description" cols="10" rows="3" class="form-control" placeholder="Enter Product Description">{{$packagingMatirials->product_description}}</textarea>
	                                </div>
                                    <div class="form-group col-md-12">
	                                        ...
	                                        @if($materialTypes)
												@foreach($materialTypes as $materialType)
													<option value="{{$materialType->id}}" 
														{{ $packagingMatirials->material_type_id == $materialType->id ? 'selected' : ''  }}
													>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input value='{{$packagingMatirials->quantity_per_bundle}}' required type="text" class="form-control" id="quantity_per_bundle" name="quantity_per_bundle" placeholder="Enter Quantity Per Bundle">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="address" class="ul-form__label">Bundle Qty Per Truck Load<span class="text-danger">*</span></label>
                                        <input type="text" required value='{{$packagingMatirials->bundle_qty_per_truck_load}}' class="form-control" id="bundle_qty_per_truck_load" name="bundle_qty_per_truck_load" placeholder="Enter Bundle Qty Per Truck Load">
                                    </div>
                                    <div class="form-group col-md-12">
	                                       ...
	                                       <!--  <option value="">--Select--</option>
	                                        @if ($producttemp)
												@foreach($producttemp as $key=>$value)
													<option value="{{ $value }}"
														{{ $packagingMatirials->product_temperature == $value ? 'selected' : ''  }}
													>{{ $value }}</option>
												@endforeach
											@endif -->
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="number" class="form-control" value='{{$packagingMatirials->bluck_price}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" name="bluck_price" id="bluck_price" placeholder="Enetr Bulk Price">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input class="form-control" <?php if (!isset($packagingMatirials->has_barcode) || $packagingMatirials->has_barcode != 1) echo 'disabled' ?> value='{{$packagingMatirials->scannable_barcode}}' id="scannable_barcode" name="scannable_barcode" placeholder="Enter Scannable Barcode">
                                    </div>                                  
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" class="form-control" id="weight" value='{{$packagingMatirials->weight}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  name="weight" placeholder="Enter Weight">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="external_length" class="ul-form__label">External Length:</label>
                                    <input type="number" class="form-control" id="external_length" value='{{$packagingMatirials->external_length}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  name="external_length" placeholder="Enter External Length">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="external_width" class="ul-form__label">External Width:</label>
                                    <input type="number" class="form-control" id="external_width"  value='{{$packagingMatirials->external_width}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  name="external_width" placeholder="Enter External Width">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="external_height" class="ul-form__label">External Height:</label>
                                    <input type="number" class="form-control" id="external_height" value='{{$packagingMatirials->external_height}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  name="external_height" placeholder="Enter External Height">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="internal_length" class="ul-form__label">Internal Length:</label>
                                    <input type="number" class="form-control" id="internal_length" value='{{$packagingMatirials->internal_length}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  name="internal_length" placeholder="Enter Internal Length">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="internal_width" class="ul-form__label">Internal Width:</label>
                                    <input type="number" class="form-control" id="internal_width" value='{{$packagingMatirials->internal_width}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  name="internal_width" placeholder="Enter Internal Width">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="internal_height" class="ul-form__label">Internal Height:</label>
                                    <input type="number" class="form-control" id="internal_height" value='{{$packagingMatirials->internal_height}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  name="internal_height" placeholder="Enter Internal Height">
                                </div>                               
                            </div>
                            <div class="col-md-3">
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" class="form-control" value='{{$packagingMatirials->cost}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" id="cost" name="cost" placeholder="Enter Cost">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="new_cost" class="ul-form__label">New Cost:</label>
                                    <input type="number" class="form-control"  value='{{$packagingMatirials->new_cost}}' min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" id="new_cost" name="new_cost" placeholder="Enter New Cost">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="new_cost_date" class="ul-form__label">New Cost Date:</label>
                                     <input type="text" class="form-control flatpickr" value='{{$packagingMatirials->new_cost_date}}' id="new_cost_date" name="new_cost_date">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="acquisition_cost" class="ul-form__label">Acquisition Cost:</label>
                                    <input type="number" min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" value='{{$packagingMatirials->acquisition_cost}}' name="acquisition_cost" id="acquisition_cost" class="form-control" placeholder="Enter Capacity Cubic">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="capacity_cubic" class="ul-form__label">Capacity Cubic:</label>
                                    <input type="number" min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" value='{{$packagingMatirials->capacity_cubic}}' name="capacity_cubic" id="capacity_cubic" class="form-control" placeholder="Enter Capacity Cubic">
                                </div>
                                <div class="form-group col-md-12">
	                                <label for="phone" class="ul-form__label">Supplier Product Number</label>
	                                <input type="text" class="form-control" value='{{$packagingMatirials->supplier_product_number}}' id="supplier_product_number" name="supplier_product_number" placeholder="Enter Supplier Product Number">
	                            </div>                                <!-- 
                                <div class="form-group col-md-12">
                            ...
                            <div class="col-md-3">
                                        ...
                                        @if ($warehouse)
											@foreach($warehouse as $warehouses)
												<tr>
													<td>{{ $warehouses }}</td>
													<td>
														<input type="checkbox" name="warehouse[]" value="{{ $warehouses }}" 
															{{ in_array($warehouses ,explode(',',$packagingMatirials->warehouses_assigned)) ? 'checked' :''}}
														>
													</td>
													<td></td>
												</tr>
	                                ...
	                                <select class="form-control select2" id="clients_assigned" name="clients_assigned">
	                                    ...
	                                    @if ($client)
											@foreach($client as $key=>$value)
												<option value="{{ $key }}"
													{{ $packagingMatirials->clients_assigned == $key ? 'selected' : ''  }}
												>{{ $value }}</option>
											@endforeach
										@endif
	                                </select>
                                    ...
                                    <select id="channel_name" class="form-control select2" name="channel_ids[]" multiple>
                                        ...
                                        @isset($channels)
                                            ...
                                            @foreach ($channels as $channel)
                                                <option value="{{ $channel['id'] }}" <?php if(in_array($channel['id'], $channel_list)) echo 'selected';?>>
                                                    {{ $channel['channel'] }}
                                                </option>
                                            @endforeach
                                        @endisset
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select onchange="populateProduct()" id="unit_description" class="form-control select2" name="unit_desc">
                                        <option value="">--Select--</option>
                                        @isset($all_unit_descs)
                                            @foreach ($all_unit_descs as $ud)
                                                <option value="{{ $ud }}" <?php if ($ud == $packagingMatirials->unit_desc) echo 'selected'; ?>>{{ $ud }}</option>
                                            @endforeach                                                
                                        @endisset
                                    </select>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <select onchange="populateProduct()" id="item_form_description" class="form-control select2" name="item_form_desc">
                                        <option value="">--Select--</option>
                                        @isset($all_item_form_descs)
                                            @foreach ($all_item_form_descs as $ud)
                                                <option value="{{ $ud }}" <?php if ($ud == $packagingMatirials->item_form_desc) echo 'selected'; ?>>{{ $ud }}</option>
                                            @endforeach                                                
                                        @endisset
                                    </select>
                                </div>
                                    ...
                                    <select id="product_name" class="form-control select2" name="product_ids[]" multiple>
                                        ...
                                        @isset($products)
                                            ...
                                            @foreach ($products as $product)
                                                <option value="{{ $product['id'] }}" <?php if(in_array($product['id'], $product_list)) echo 'selected';?>>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @foreach (range(1, 5) as $td)
                                            <div class="form-group col-md-12">
                                                ...
                                                <input value='{{ isset($wh_td_count[$warehouses][$td]) ? $wh_td_count[$warehouses][$td] : '' }}' type="number" class="form-control" id="{{ $wh_lower }}_td_{{ $td }}" name="{{ $wh_lower }}_td_{{ $td }}" placeholder="Max Item for Transit Day {{ $td }}">
                                            </div>
                                        @endforeach                                                                      
                                    </div>  
                                @endforeach
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="hidden" id="selected_packages" value="{{json_encode($packageKitComponents->pluck('qty','pid'))}}">
                                ...
                                <table class="table table-border table-stripped" id="parent_kit_packaging_selected">
                                    ...
                                    <tbody>
                                        @foreach($packageKitComponents as $packageKitComponentsKey => $packageKitComponentsVal)
                                            <tr id="{{$packageKitComponentsVal->pid}}">
                                                <td>{{$packageKitComponentsVal->components_ETIN}}</td>
                                                <td>{{$packageKitComponentsVal->product_description}}</td>
                                                <td>
                                                    <input type="hidden" name="kit_components[{{$packageKitComponentsVal->pid}}][components_ETIN]" value="{{$packageKitComponentsVal->components_ETIN}}" id="kit_components_etin">
                                                    <input type="number" class="form-control" name="kit_components[{{$packageKitComponentsVal->pid}}][qty]" value="{{$packageKitComponentsVal->qty}}" id="kit_components_qty" style="width:55px;padding:0px">
                                                </td>
                                                <td>
                                                    <a href="javascript:void(0)" class="btn btn-danger" onClick="removeProduct({{$packageKitComponentsVal->pid}})">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="submit" class="btn  btn-primary m-1">Submit</button>
                                     @if($pagetype == 'packaginglist')
                                        <a href="{{ route('listpackagingmatirial.index') }}" class="btn btn-outline-secondary m-1">Cancel</a>
                                    @else
...
<script type="text/javascript">
	...
	submitHandler(form){
		...
		$.ajax({
			type: "POST",
			url: '{{route('updatepackagematerial',$packagingMatirials->id)}}',
			data: form1,
			processData: false,
			contentType: false,
 ...
 getSupplierPackaging = () =>  {
        ...
        autoWidth: false,
        ajax:{
                url: '{{ route('getpackagingbysupplier',$packagingMatirials->supplier_id) }}',
                method:'GET',
                data: function(d){
