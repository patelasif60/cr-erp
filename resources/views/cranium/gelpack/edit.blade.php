        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                <div class="card-header bg-transparent">
                    <h6 class="card-title task-title">Edit Gel Pack Chart Template</h6>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" required class="form-control" id="template_name" name="template_name" value="{{$gelPackTemplate->template_name}}">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="template__description" class="ul-form__label">Template Description:</label>
                                <textarea name="template__description" required id="template__description" cols="10" rows="3" class="form-control">{{$gelPackTemplate->template__description}}</textarea>
                            </div>
                            ...
                            <div class="card-body">
                                <table class="table-responsive">
                                    ...
                                    <tbody>
                                        @foreach($gelEditArray as $key=>$val)
                                            @if(isset($result[$val->packaging_materials_id]))
                                                <tr>
                                                    ...
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][0][1lbpack]" value="{{$val['1day_1lb_pack']}}">
                                                    </td>
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][0][2lbpack]"value="{{$val['1day_2lb_pack']}}">
                                                    </td>
                                                    <td class="table_border">
                                                    ...
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][1][1lbpack]" value="{{$val['2day_1lb_pack']}}">
                                                    </td>
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][1][2lbpack]"value="{{$val['2day_2lb_pack']}}">
                                                    </td>
                                                    <td class="table_border">
                                                    ...
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][2][1lbpack]" value="{{$val['3day_1lb_pack']}}">
                                                    </td>
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][2][2lbpack]"value="{{$val['3day_2lb_pack']}}">
                                                    </td>
                                                    <td class="table_border">
                                                    ...
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][3][1lbpack]" value="{{$val['4day_1lb_pack']}}">
                                                    </td>
                                                    <td class="table_border">
                                                        <input type="number" step="any" class="form-control standard" name="chartsval[{{$val->packaging_materials_id}}][3][2lbpack]"value="{{$val['4day_2lb_pack']}}">
                                                    </td>
                                                </tr>
                                            @endif
                                        @endforeach
       ...
       $(document).ready(function () {
            $("#new_gel_pack_chart_template").validate({
                submitHandler(form){
                    ...
                    $.ajax({
                        type: "POST",
                        url: '{{ route('gelpack.update',$gelPackTemplate->id) }}',
                        data: form1,
                        processData: false,
                        contentType: false,
