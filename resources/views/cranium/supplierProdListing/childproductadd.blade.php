...
<div class="card">
	<div class="card-header bg-transparent">
		<div class="col-md-6" style="float: left;">
			<h3 class="card-title"> Adding Child Product of ETIN: <b> {{$productdetails->ETIN}} </b></h3>
		</div>
	</div>
<!--begin::form-->
	<form method="POST" action="{{ route('addchildproduct') }}" enctype="multipart/form-data" id="product_add">
	@csrf
	@method('put')
		<div class="card-body ">
			<!----------===================================================------------>
			<div class="row col-lg-12">
				<div class="col-lg-8">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" id="parent_ETIN" placeholder="Parent ETIN" name ="parent_ETIN" value="{{$productdetails->ETIN}}" readonly>
					</div>
					<div class="form-group col-md-6">
					...
					<div class="form-group col-md-6">
						...
						<select id="product_temperature" name="product_temperature" class="form-control @if(moduleacess('child_edit_tmp') == false) custom_readonly @endif" id="product_temperature" >
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="flavor" name="flavor" placeholder="Flavor Variation" value="{{$productdetails->flavor}}" readonly>
								</div>
								<div class="form-group col-md-12">
							...
							<div class="col-md-4">
								...
								<div class="form-group col-md-12">
									...
									<div class="row">
										<div class="col-md-6">
											<input type="number" id="unit_num" name="unit_num" class="form-control" value="{{$productdetails->unit_num}}" placeholder="Select Unit Count" min="0.0001" step="0.0001" pattern="^\d+(?:\.\d{1,4})?$" >
										</div>
										<div class="col-md-6">
								...
								<div class="form-group col-md-6">
									...
									@if ($producttag)
										@foreach($producttag as $key=>$producttaglist)
										  @if(!in_array($key,$productdetails->product_tags_array))
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="supplier_description" name="supplier_description" placeholder="Supplier Description" value="{{$productdetails->supplier_description}}" readonly>
								</div>
								<div class="form-group col-md-12">									
									<div class="row">
										<div class="col-md-4">
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" id="GPC_code" name="GPC_code" placeholder="GPC Code" value="{{$productdetails->GPC_code}}" readonly>
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" id="GPC_class" name="GPC_class" placeholder="GPC Class" value="{{$productdetails->GPC_class}}" readonly>
												</td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Harmonized System for International shipping">HS Code</td>
												<td>
													<input type="text" class="form-control text-center" id="HS_code" name="HS_code" placeholder="HS Code" value="{{$productdetails->HS_code}}" readonly>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="MFG_shelf_life" name="MFG_shelf_life" placeholder="MFG Shelf Life" value="{{$productdetails->MFG_shelf_life}}" min="1" max="99999" readonly>
								</div>
								<div class="form-group col-md-12">
								...
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="ingredients" name="ingredients" placeholder="Ingredients" value="{{$productdetails->ingredients}}" readonly>
								</div>
							</div>
							<div class="col-md-4">
								<!-- <div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="allergens" name="allergens" placeholder="Allergens" value="{{$productdetails->allergens}}" readonly>
								</div> -->
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="storage" name="storage" placeholder="Storage" value="{{$productdetails->storage}}" readonly>
								</div>
								<div class="form-group col-md-12">
									...
									<div class="custom_one_line_cards_container AllergensDrop border">
										@if ($allergens)
											@foreach($allergens as $key=>$row_allergens)
												@if(!in_array($key,$productdetails->allergens_array))
													<div class="allergens_cards custom_one_line_cards" id="{{ $key }}">{{ $row_allergens }}</div>
												@endif
											@endforeach
										@endif
									</div>
