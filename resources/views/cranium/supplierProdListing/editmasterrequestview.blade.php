	...
	<div class="col-md-6">
		@if($prevProductId != NULL)
			<div class="btn btn-primary btn-icon m-1"  style="float: left; text-align: right;">
				...
				<a href="{{ url('editmasterrequestview/'.$prevProductId) }}" class="ul-btn__text" style="color:#fff;"> Previous </a>
			</div>
	...
	<div class="col-md-6">
		@if($nextProductId != NULL)
			<div class="btn btn-primary btn-icon m-1"  style="float: right; text-align: right;">
				<a href="{{ url('editmasterrequestview/'.$nextProductId) }}" class="ul-btn__text" style="color:#fff;"> Next </a>
...
<div class="row mb-3">
	<div class="col-md-6">
		@if($prevDraftProductId != NULL)
			<div class="btn btn-primary btn-icon m-1"  style="float: left; text-align: right;">
			<span class="ul-btn__icon mr-1"><i class="fa fa-arrow-left" aria-hidden="true"></i></span>
				<a href="{{ url('editmasterrequestview/'.$prevDraftProductId) }}" class="ul-btn__text" style="color:#fff;"> Previous </a>
			</div>
		@endif
	</div>
	<div class="col-md-6">
		@if($nextDraftProductId != NULL)
			<div class="btn btn-primary btn-icon m-1"  style="float: right; text-align: right;">
				<a href="{{ url('editmasterrequestview/'.$nextDraftProductId) }}" class="ul-btn__text" style="color:#fff;"> Next </a>
				<span class="ul-btn__icon ml-1"><i class="fa fa-arrow-right" aria-hidden="true"></i></span>
			</div>
		@endif
	</div>
...
<form method="POST" action="" id="product_add" enctype="multipart/form-data">
	...
	<div class="card-header bg-transparent">
		...
		@if($productdetails->queue_status != 'd')
			@if(ReadWriteAccess('ProductEditsPendingApprovalApproveDeny'))
			...
			<div class="btn btn-danger btn-outline btn-icon m-1"  style="float: right; text-align: right;">
				...
				<a href="{{ url('ApproveOrRejectProductRequest/'.$productdetails->ETIN) }}/0" class="ul-btn__text" style="color:#fff;"> Reject </a>
			</div>
			@endif
		@endif
...
<div class="row" style="width:100%">
	<div class="col-md-12">
		@if($productdetails->is_approve == 0  && $productdetails->queue_status != 'd')
			<!--<a href="{{route('updateflag', $productdetails->id)}}" id="updateflag"><div direction="left" class="marqueeclass">This Product is not approved yet. Click Here  to approve </div></a>-->
			<a href="#">
		...
		<div class="card-body">
			...
			<input type="hidden" value="{{$productdetails->master_product_id}}" name='master_product_id' id="master_product_id">
						...
						<div class="row mt-4">
							<div class="col-md-3">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control <?php if(isset($producthistory)){ if($producthistory->flavor != $productdetails->flavor) echo "edited-field";}?>" id="flavor" name="flavor" placeholder="Flavor Variation" value="{{$productdetails->flavor}}">
								</div>
								<div class="form-group col-md-12">
								...
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control <?php if(isset($producthistory)){ if($producthistory->pack_form_count != $productdetails->pack_form_count) echo "edited-field";}?> " id="pack_form_count" name="pack_form_count" placeholder="Pack Form Count" min="1" value="{{$productdetails->pack_form_count}}">
								</div>
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control <?php if(isset($producthistory)){ if($producthistory->unit_in_pack != $productdetails->unit_in_pack) echo "edited-field";}?> " id="unit_in_pack" name="unit_in_pack" placeholder="Units in Pack" min="1" value="{{$productdetails->unit_in_pack}}" >
								</div>
								<div class="form-group col-md-12">
									...
									<table class="table ">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->weight != $productdetails->weight) echo "edited-field";}?>" id="weight" name="weight" placeholder="Weight (lbs)" value="{{$productdetails->weight}}"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Length of the item/unit in inches (in)">Length (in) </td>
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->length != $productdetails->length) echo "edited-field";}?>" id="length" name="length" placeholder="Length (in)" value="{{$productdetails->length}}"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Width (depth)of the item/unit in inches (in)">Width (in) </td>
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->width != $productdetails->width) echo "edited-field";}?>" id="width" name="width" placeholder="Width (in)" value="{{$productdetails->width}}"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Height of the item/unit in inches (in)">Height (in) </td>
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->height != $productdetails->height) echo "edited-field";}?>" id="height" name="height" placeholder="Height (in)" value="{{$productdetails->height}}"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
										</tbody>
									</table>
									...
									<div class="row">
										...
										<input type="number" id="unit_num" name="unit_num" class="form-control <?php
											...
											if(isset($producthistory)){
												...
												if($productdetails->unit_num != $unit_num) echo "edited-field";}?>"  value="{{$productdetails->unit_num}}" placeholder="Select Unit Count"  min="0.0001" step="0.0001" pattern="^\d+(?:\.\d{1,4})?$">
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control <?php if(isset($producthistory)){ if($producthistory->full_product_desc != $productdetails->full_product_desc) echo "edited-field";}?> " id="full_product_desc" name="full_product_desc" placeholder="Full Product Descrtiption" value="{{$productdetails->full_product_desc}}" >
								</div>
								<div class="form-group col-md-12">
									<label for="about_this_item" class="ul-form__label <?php if(isset($producthistory)){ if($producthistory->about_this_item != $productdetails->about_this_item) echo "edited-field";}?>" data-toggle="tooltip" data-placement="top" title="Bullet points highlighting the item in Amazon's 'About this item' section">About This Item</label>
										...
										<input type="text" class="form-control  mb-3" id="about_this_item_1" name="about_this_item[]" placeholder="Point 1" value="@if(isset($about_this_item[0])){{$about_this_item[0]}}@endif">
										<input type="text" class="form-control  mb-3" id="about_this_item_2" name="about_this_item[]" value="@if(isset($about_this_item[1])){{$about_this_item[1]}}@endif" placeholder="Point 2">
										<input type="text" class="form-control  mb-3" id="about_this_item_3" name="about_this_item[]" value="@if(isset($about_this_item[2])){{$about_this_item[2]}}@endif" placeholder="Point 3">
										<input type="text" class="form-control  mb-3" id="about_this_item_4" name="about_this_item[]" value="@if(isset($about_this_item[3])){{$about_this_item[3]}}@endif" placeholder="Point 4">
										<input type="text" class="form-control mb-3" id="about_this_item_5" name="about_this_item[]" value="@if(isset($about_this_item[4])){{$about_this_item[4]}}@endif" placeholder="Point 5">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<table class="table ">
										<tbody>
											...
											<tr>
												...
												<td>
													@if($productdetails->is_approve == 1)
														<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->cost != $productdetails->cost) echo "edited-field";}?>" placeholder="Cost" id="cost" name="cost" value="{{$productdetails->cost}}" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" readonly>
													@else
                                            ...
                                            <tr>
												...
												<td>
													@if($productdetails->is_approve == 1)
														<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->acquisition_cost != $productdetails->acquisition_cost) echo "edited-field";}?>" placeholder="Acquisition Cost" id="acquisition_cost" name="acquisition_cost" value="{{$productdetails->acquisition_cost}}" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" readonly>
													@else
								...
								<table class="table card_">
									...
									<tbody>
										<tr>
											...
											<td>
												<input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->supplier_product_number != $productdetails->supplier_product_number) echo "edited-field";}?>" placeholder="Supplier Product Number" id="supplier_product_number" name="supplier_product_number" value="{{$productdetails->supplier_product_number}}">
											</td>
										</tr>
										<tr>
											<td scope="row" data-toggle="tooltip" data-placement="top" title="Manufacturer's product number">Manufacturer Product Number</td>
											<td>
												<input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->manufacture_product_number != $productdetails->manufacture_product_number) echo "edited-field";}?>" placeholder="Manufacturer Product Number" id="manufacture_product_number" name="manufacture_product_number" value="{{$productdetails->manufacture_product_number}}">
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->GPC_code != $productdetails->GPC_code) echo "edited-field";}?> " id="GPC_code" name="GPC_code" placeholder="GPC Code" value="{{$productdetails->GPC_code}}">
											</td>
										</tr>
										<tr>
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control <?php if(isset($producthistory)){ if($producthistory->MFG_shelf_life != $productdetails->MFG_shelf_life) echo "edited-field";}?>" id="MFG_shelf_life" name="MFG_shelf_life" placeholder="MFG Shelf Life" value="{{$productdetails->MFG_shelf_life}}" min="1" max="99999" >
								</div>
								<div class="form-group col-md-12">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control <?php if(isset($producthistory)){ if($producthistory->ingredients != $productdetails->ingredients) echo "edited-field";}?> " id="ingredients" name="ingredients" placeholder="Ingredients" value="{{$productdetails->ingredients}}">
								</div>
										...
										@if ($allergens)
											@foreach($allergens as $key => $row_allergens)
												@if(!in_array($key,$allergens_assigned))
													<div class="allergens_cards custom_one_line_cards  <?php if(isset($producthistory)){ if($producthistory->allergens != $productdetails->allergens) echo "edited-field";}?>" id="{{ $key }}">{{ $row_allergens }}</div>
												@endif
											@endforeach
										@endif
									</div>
			...
			<div class="mc-footer">
				<div class="row">
					<div class="col-lg-12 text-center">
							...
							@endif
							<a type="cancel" href="{{url('/allmasterproductlsts')}}" class="btn btn-outline-secondary m-1">Cancel</a>
...
var table = $('#product_history_table').DataTable({
	...
	ajax:{
		...
		url: '{{ route('getProductHistory',$productdetails->master_product_id) }}',
		<?php }?>
		method:'GET',
	},
	columns: [
...
// 		autoWidth: false,
// 		ajax:{
// 			url: '{{ route('datatable.ProductTicketsList',[$productdetails->id,"master_product_queue"]) }}',
// 			method:'GET',
// 		},
// 		columns: [
// 			// {data: 'id', name: 'ID'},
...
// $('#btnApprove').click(function(e){
	...
	$("#product_add").submit(function(e) {
		...
		let form1 = new FormData(form_cust);
		// var form = $('#product_add');
		var url = "{{ url('ApproveProductRequest/'.$productdetails->id) }}/1";
		console.log(form1);
		$.ajax({
			type: "POST",
			url: url,
