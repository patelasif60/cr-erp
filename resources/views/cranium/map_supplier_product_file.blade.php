    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="return_container">
            @if(empty($csvHeader))
                <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data" id="form_upload">
                    ...
                    <div class="form-group">
                        <label for="csv_formate" class="control-label col-md-4">Assigned Supplier Table:</label>
                        <div class="col-md-12">
                            <select id="csv_formate" required name="csv_formate" class="form-control">
                                ...
                                <option value="supplier_harsley" >HERSLEY</option>
            ...
            @else
                ...
                <a href="{{ route('suppliers.delete_supplier_product_header',$csvHeader->id) }}" class="btn btn-danger" onClick="return confirm('are you sure?')">Delete Mapping</a>
            @endif
        </div>
    </div>
</div>
