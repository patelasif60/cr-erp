    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="javascript:void(0)" id="edit_allergens_form" >
            ...
            <div class="modal-body">
                <lable for="kit_description">Allergens</lable>
                <input type="text" name="kit_description" class="form-control" placesholder="Edit Allergens" id="kit_description" style="width:100%;" value="{{ $row['kit_description'] }}"/> 
            </div> 
...
$("#edit_allergens_form").validate({
    submitHandler(form){
        ...
        $.ajax({
            type: "POST",
            url: '{{route('kit_description.update',$row['id'])}}',
            data: form1, 
            processData: false,
            contentType: false,
