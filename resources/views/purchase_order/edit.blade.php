                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control date_picker" id="order_date" name="order_date" placeholder="Enter Order Date" value="{{ $ps->purchasing_asn_date }}"/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group col-md-12">
                                    <label for="name" class="ul-form__label">Delivery Date:<?php echo $required_span; ?></label>
                                    <input type="text" class="form-control date_picker" id="delivery_date" name="delivery_date" placeholder="Enter Delivery Date" value="{{ $ps->delivery_date }}"/>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="name" class="ul-form__label">Delivery Fees:</label>
                                    <input type="text" class="form-control" id="delivery_fees" name="delivery_fees" placeholder="Enter Delivery Fees" value="{{ $ps->delivery_inbound_fees }}"/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group col-md-12">
                                    <label for="name" class="ul-form__label">Freight Fees:</label>
                                    <input type="text" class="form-control" id="freight_fees" name="freight_fees" placeholder="Enter Freight Fees" value="{{ $ps->freight_shipping_charge }}"/>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="name" class="ul-form__label">Surcharge Fees:</label>
                                    <input type="text" class="form-control" id="surcharge" name="surcharge" placeholder="Enter Surcharge" value="{{ $ps->surcharge_1 }}"/>
                                </div>
                            </div>                            
                            <div class="col-lg-12">
    ...
    <script>
        ...
        function PurchaseOrderProducts(warehouseId, onload) {
            table1 = $('#purchase_order_products').DataTable({
                ...
                ajax:{
                        url: onload ? '{{ route('datatable.SavedPurchaseOrderProducts') }}' : '{{ route('datatable.PurchaseOrderProducts') }}',
                        method: 'GET',
                        data: function(d) {
