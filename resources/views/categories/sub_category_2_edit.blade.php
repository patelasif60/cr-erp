...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header" style="background-color:#fff;">
            <h3>Update New Sub Category 2</h3>
        ...
        <form action="#" method="POST" id="add_category">
            ...
            <input type="hidden" class="form-control" name="sub_category_2_original" value="{{ $row->sub_category_2 }}">   
            ...
            <div class="modal-body">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="sub_category_2" name="sub_category_2" placeholder="Enter Product Category 2" value="{{ $row->sub_category_2 }}">
                </div>
                <div class="form-group col-md-12">
                    <label for="sc2_sa_code" class="ul-form__label">SC2 SA Code:</label>
                    <input type="text" class="form-control" id="sc2_sa_code" name="sc2_sa_code" placeholder="Enter SC2 SA Code" value="{{ $row->sc2_sa_code }}">
                </div>
            </div> 
...
<script>
    $("#add_category").on('submit',function(e){
        ...
        $.ajax({
            type: "POST",
            url: '{{ route('categories.sub_category_2_update') }}',
            data: form1, 
            processData: false,
            contentType: false,
