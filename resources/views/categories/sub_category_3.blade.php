        ...
        <form action="#" method="POST" id="add_category">
            ...
            <div class="modal-body">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="sub_category_3" name="sub_category_3" placeholder="Enter Product Category 3">
                </div>
                <div class="form-group col-md-12">
                    <label for="sc3_sa_code" class="ul-form__label">SC3 SA Code:</label>
                    <input type="text" class="form-control" id="sc3_sa_code" name="sc3_sa_code" placeholder="Enter SC3 SA Code">
                </div>
            </div> 
...
<script>
    $("#add_category").on('submit',function(e){
        ...
        $.ajax({
            type: "POST",
            url: '{{ route('categories.sub_category_3_store') }}',
            data: form1, 
            processData: false,
            contentType: false,
