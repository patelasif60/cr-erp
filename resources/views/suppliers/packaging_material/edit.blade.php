        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                <div class="card-header bg-transparent">
                    <h6 class="card-title task-title">Edit Packaging & Material</h6>
                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input required value='{{$packagingMatirials->quantity_per_bundle}}' type="text" class="form-control" id="quantity_per_bundle" name="quantity_per_bundle" placeholder="Enter Quantity Per Bundle">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="address" class="ul-form__label">Bundle Qty Per Truck Load<span class="text-danger">*</span></label>
                                        <input required type="text" value='{{$packagingMatirials->bundle_qty_per_truck_load}}' class="form-control" id="bundle_qty_per_truck_load" name="bundle_qty_per_truck_load" placeholder="Enter Bundle Qty Per Truck Load">
                                    </div>
                                    <div class="form-group col-md-12">
	                                    ...
	                                    <select class="form-control select2" id="product_temperature" name="product_temperature">
	                                        <option value="">--Select--</option>
                                            <option value="Packaging" {{ $packagingMatirials->product_temperature == "Packaging" ? 'selected' : ''  }}>Packaging</option>
	                                        @if ($producttemp)
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="sales_manager" class="ul-form__label">Client:</label>
                                        <select class="form-control select2" id="client_assigned" name="clients_assigned" onchange="fetchChannelAndProduct(this.value)">
                                            ...
                                            @if ($client)
                                                @foreach($client as $key=>$value)
                                                    <option value="{{ $key }}" <?php if($key == $packagingMatirials->clients_assigned) echo 'selected';?> >{{ $value }}</option>
                                                @endforeach
                                            @endif                                        
                                        </select>
                                    </div>	                            	                            
                            ...
                            <div class="col-md-3">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control" id="status" name="status" >
                                        <option {{$packagingMatirials->status == 'Active' ? 'selected' : '' }} value="Active">Active</option>
                                        <option {{$packagingMatirials->status == 'Inactive' ? 'selected' : '' }} value="Inactive">Inactive</option>
                                        <option {{$packagingMatirials->status == 'Secondary' ? 'selected' : '' }} value="Secondary">Secondary</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" value='{{$packagingMatirials->acquisition_cost}}' name="acquisition_cost" id="acquisition_cost" class="form-control" placeholder="Enter Acquisition Cost">
                                </div>
                                <div class="form-group col-md-12">
                                        ...
                                        @if ($warehouse)
											@foreach($warehouse as $warehouses)
												<tr>
													<td>{{ $warehouses }}</td>
													<td>
														<input type="checkbox" calss="js-warehouseval" name="warehouse[]" value="{{ $warehouses }}" 
