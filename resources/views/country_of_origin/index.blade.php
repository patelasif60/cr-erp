        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                <div class="card-header text-right bg-transparent">
                    ...
                    <a href="#" class="btn btn-primary btn-md m-1" onClick="GetModel('{{route('country.create')}}')"><i class="i-Add text-white mr-2"></i>Add Country Of Origin</a>
                    @endif
                </div>
                <div class="card-body">
    ...
    <script>
       $(document).ready(function () {
            ...
            var dt = $('#CountryList').DataTable({
                ...
                ajax: '{!! route('datatable.CountryList') !!}',
                columns: [
