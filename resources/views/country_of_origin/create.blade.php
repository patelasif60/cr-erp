    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="javascript:void(0)" id="add_manufacturer_form" >
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" name="country_of_origin" placesholder="country of origin" id="country_of_origin" style="width:100%;"/> 
            </div> 
