    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="javascript:void(0)" id="edit_manufacturer_form" >
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" name="product_status" placesholder="Edit product_status" id="product_status" style="width:100%;" value="{{ $row['product_status'] }}"/> 
            </div> 
...
$("#edit_manufacturer_form").validate({
    submitHandler(form){
        ...
        $.ajax({
            type: "POST",
            url: '{{route('product_statuses.update',$row['id'])}}',
            data: form1, 
            processData: false,
            contentType: false,
