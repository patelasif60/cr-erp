  ...
  <div class="row">
    <div class="col-3">
      <div class="form-group">
        ...
        <input type="date" name="os_tb_start_date" id="os_tb_start_date" class="form-control w-100" value="<?php echo e($start_date); ?>">      
      </div>
    </div>
    <div class="col-3">
      <div class="form-group">
        <label for="os_tb_end_date">End Date</label>
        <input type="date" name="os_tb_end_date" id="os_tb_end_date" class="form-control date w-100" value="<?php echo e($end_date); ?>">
      </div>
    </div>
    <div class="col-3">
      <div class="form-group">
...
<script>
  ...
  function tableByOrderStatus(type){
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo e(route('pipeline_and_metrix.GetOrderStatusTable')); ?>',
      data: form1,
      processData: false,
      contentType: false,
...
<?php /**PATH C:\wamp64\www\cranium_new\resources\views/report_section/parts/container_tb_total_os.blade.php ENDPATH**/ ?>