...
<div class="breadcrumb">
	...
	<div class="col-md-12 p-5">
		<a class="btn btn-primary float-right" href="<?php echo e(route('orders.create')); ?>">
			<img src="<?php echo e(asset('assets/images/addnew.png')); ?>" style="width: 15px; cursor: pointer;">&nbsp; New Manual Order
		</a>
		<a style="margin-right: 10px" class="btn btn-primary float-right" href="<?php echo e(route('orders.bulk_upload_order')); ?>">
			<img src="<?php echo e(asset('assets/images/addnew.png')); ?>" style="width: 15px; cursor: pointer;">&nbsp; Bulk Upload Order
		</a>
					...
					<div class="col-md-9">
						...
						<div class="d-inline w-25">
							<select name="warehouse" class="form-control select2"   multiple>
								<?php echo e(GetOption(['table' => 'warehouses', 'value' => 'warehouses' , 'label' => 'warehouses','selected_value' => '','column_name'=>'warehouses'])); ?>
						...
						<a href="<?php echo e(url('/summery_orders')); ?>" class="btn btn-warning">Clear Filters</a>
						<?php endif; ?>
					</div>
					<div class="col-md-3">
						<?php if($id != NULL): ?>
...
<div class="row">
						...
						<?php if($product_listing_filter): ?>
							<?php $__currentLoopData = $product_listing_filter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row_product_listing_filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<div class="dropdown mb-2 fl_<?php echo e($row_product_listing_filter->sorting_order); ?>" style="<?php if($display == true) echo "display:inline-block !important"; else echo "display:none"?>">
									<a class="btn btn-secondary dropdown-toggle dropdown-filter" href="#" role="button" id="dropdownMenuLink<?php echo e($row_product_listing_filter->id); ?>_auto" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink" >
										...
										?>
										<input type="hidden" name="main_filter[<?php echo e($row_product_listing_filter->column_name); ?>_auto]" id="main_filter_<?php echo e($row_product_listing_filter->column_name); ?>_auto" value="<?php echo e($selected_value); ?>">
										...
										<?php $hidden_all = true;?>
										<select name="boolean_filters[<?php echo e($row_product_listing_filter->column_name); ?>]" class="form-control" id="drop_down_<?php echo e($row_product_listing_filter->column_name); ?>_auto">
										...
										<?php elseif($row_product_listing_filter->text_or_select !== 'Date'): ?>
										<select name="<?php echo e($row_product_listing_filter->column_name); ?>_auto" class="form-control select2" id="drop_down_<?php echo e($row_product_listing_filter->column_name); ?>_auto" onchange="GetSelectedValue(this,'<?php echo e($row_product_listing_filter->column_name); ?>_auto')" multiple>
										...
										<?php endif; ?>
											...
											<div class="div-main mt-3" id="div_main_<?php echo $row_product_listing_filter->id; ?>" >
												<div >
													<?php if($row_product_listing_filter->text_or_select !== 'Date'): ?>
														<div class="row">
															<div class="col-sm-3">
													...
													<?php else: ?>
														<div class="row">
															<div class="col-sm-6">
																<label for="date_auto_<?php echo e($row_product_listing_filter->id); ?>_onorbefore">On Or Before: </label>
															</div>
															<div class="col-sm-6">
																<input type="date" 
																	style="width:100%" 
																	name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][onorbefore_auto]" 
																	id="date_auto_<?php echo e($row_product_listing_filter->id); ?>_onorbefore" 
															...
															<div class="col-sm-6">
																<label for="date_auto_<?php echo e($row_product_listing_filter->id); ?>_onorafter">On Or After: </label>
															</div>
															<div class="col-sm-6">
																<input type="date" 
																	style="width:100%" 
																	name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][onorafter_auto]" 
																	id="date_auto_<?php echo e($row_product_listing_filter->id); ?>_onorafter" 
																	onkeyup="CopyFieldValue('main',<?php echo $row_product_listing_filter->id; ?>)" 
															...
															<div class="col-sm-6">
																<label for="date_auto_<?php echo e($row_product_listing_filter->id); ?>_from">From: </label>
															</div>
															<div class="col-sm-6">
																<input type="date" 
																	style="width:100%" 
																	name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][from_auto]" 
																	id="date_auto_<?php echo e($row_product_listing_filter->id); ?>_from" 
																	onkeyup="CopyFieldValue('main',<?php echo $row_product_listing_filter->id; ?>)" 
															...
															<div class="col-sm-6">
																<label for="date_auto_<?php echo e($row_product_listing_filter->id); ?>_to">To: </label>
															</div>
															<div class="col-sm-6">
																<input type="date" 
																	style="width:100%" 
																	name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][to_auto]" 
																	id="date_auto_<?php echo e($row_product_listing_filter->id); ?>_to" 
																	onkeyup="CopyFieldValue('main',<?php echo $row_product_listing_filter->id; ?>)" 
												...
												<div class="main-filters-buttons mt-1">
													<div class="row">
														...
														<div class="col-sm-12 text-right">
															<button type="button" class="btn btn-warning" onclick="ClearFilterAuto('<?php echo $row_product_listing_filter->id; ?>','<?php echo e($row_product_listing_filter->column_name); ?>',this)">Clear</button>
															...
															<button type="button" class="btn btn-success"  onclick="updateFilterAuto('<?php echo $row_product_listing_filter->id; ?>','<?php echo e($row_product_listing_filter->column_name); ?>',this)">Update</button>
														</div>
													</div>
												</div>
											</div>
						...
						<table id="datatable" class="table table-bordered text-center " style="width:100%">
							<thead>
								<tr>
									<?php if($product_listing_filter): ?>
										<?php $__currentLoopData = $product_listing_filter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row_product_listing_filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($row_product_listing_filter->label_name != 'Ship Date'): ?>													
	...
	<?php if(isset($new_manual_count) && $new_manual_count > 0): ?>
		<div class="col-md-12">
			<div class="card o-hidden mb-4">
				<div class="card-header">
					<div class="row">
												...
												<div class="div-main mt-3" id="div_main_<?php echo $row_product_listing_filter->id; ?>" >
													<div >
														...
														<?php else: ?>
															<div class="row">
																<div class="col-sm-6">
																	<label for="date_<?php echo e($row_product_listing_filter->id); ?>_onorbefore">On Or Before: </label>
																</div>
																<div class="col-sm-6">
																	<input type="date" 
																		style="width:100%" 
																		name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][onorbefore]" 
																		id="date_<?php echo e($row_product_listing_filter->id); ?>_onorbefore" 
																		onkeyup="CopyFieldValue('main',<?php echo $row_product_listing_filter->id; ?>)" 
																...
																<div class="col-sm-6">
																	<label for="date_<?php echo e($row_product_listing_filter->id); ?>_onorafter">On Or After: </label>
																</div>
																<div class="col-sm-6">
																	<input type="date" 
																		style="width:100%" 
																		name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][onorafter]" 
																		id="date_<?php echo e($row_product_listing_filter->id); ?>_onorafter" 
																		onkeyup="CopyFieldValue('main',<?php echo $row_product_listing_filter->id; ?>)" 
																...
																<div class="col-sm-6">
																	<label for="date_<?php echo e($row_product_listing_filter->id); ?>_from">From: </label>
																</div>
																<div class="col-sm-6">
																	<input type="date" 
																		style="width:100%" 
																		name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][from]" 
																		id="date_<?php echo e($row_product_listing_filter->id); ?>_from" 
																		onkeyup="CopyFieldValue('main',<?php echo $row_product_listing_filter->id; ?>)" 
																...
																<div class="col-sm-6">
																	<label for="date_<?php echo e($row_product_listing_filter->id); ?>_to">To: </label>
																</div>
																<div class="col-sm-6">
																	<input type="date" 
																		style="width:100%" 
																		name="filter_val[<?php echo $row_product_listing_filter->column_name; ?>][to]" 
																		id="date_<?php echo e($row_product_listing_filter->id); ?>_to" 
																		onkeyup="CopyFieldValue('main',<?php echo $row_product_listing_filter->id; ?>)" 
													...
													<div class="main-filters-buttons mt-1">
														<div class="row">
															...
															<div class="col-sm-12 text-right">
															<button type="button" class="btn btn-warning" onclick="ClearFilter('<?php echo $row_product_listing_filter->id; ?>','<?php echo e($row_product_listing_filter->column_name); ?>',this)">Clear</button>
																<button type="button" class="btn btn-danger" onclick="openFilterDropdown('<?php echo $row_product_listing_filter->id; ?>',this)">Cancel</button>
      ...
      <div class="modal-body">
			...
			<table class="table table-bordered text-center">
				...
				<?php if($smart_filters): ?>
					...
					<?php $__currentLoopData = $smart_filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $smart_fil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td><a href="<?php echo e(url('/summery_orders')); ?>/<?php echo e($smart_fil->id); ?>" class="font-weight-bold ml-2" style="<?php if($id != NULL && $smart_fil->id == $id) echo 'color: #19bef4';?>"><?php echo e($smart_fil->filter_name); ?></a></td>
...
<?php $__env->startSection('page-js'); ?>
	...
	<script type="text/javascript">
		...
		function GetActiveProducts(ini = '', status = ''){
			$("#preloader").show();
			if(ini == ''){
				var url = '<?php echo e(route('getOptimizedordersFilter')); ?>';
			}else{
		...
		function GetActiveProducts2(ini = '', status = ''){
			$("#preloader").show();
			if(ini == ''){
				var url = '<?php echo e(route('getOptimizedordersFilter2')); ?>';
			}else{
				var url = '<?php echo e(route('getOptimizedorders2')); ?>';
			}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/orders/index.blade.php ENDPATH**/ ?>