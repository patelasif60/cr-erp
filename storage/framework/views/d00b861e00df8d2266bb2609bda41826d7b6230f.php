							...
							<tr>
								...
								<th scope="col">
									<select name="etin_filter2[]" id="etin_filter2" class="form-control select2" multiple>
										...
										<?php $__currentLoopData = $getet2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_etin2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<th scope="col">
									<select  id="listing_name_filter2" name="listing_name_filter2[]" class="form-control select2" multiple>
										<option value=''>Select</option>
										<?php $__currentLoopData = $listing_name2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ln): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<th scope="col">
									<select id="supplier_filter2" name="supplier_filter2[]" class="form-control select2" multiple>
										<option value=''>Select</option>
										<?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplierslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($supplierslist); ?>"><?php echo e($supplierslist); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								...
								<th scope="col">
									<select id="upc_filter2" name="upc_filter2[]" class="form-control select2" multiple>
										<option value=''>Select</option>
										<?php $__currentLoopData = $upcs2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upc2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($upc2); ?>"><?php echo e($upc2); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								<th scope="col">
									<select id="item_form_desc_filter2" name="item_form_desc_filter2[]" class="form-control select2" multiple>
										<option value=''>Select</option>
										<?php $__currentLoopData = $item_form_desc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ifd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($ifd); ?>"><?php echo e($ifd); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								<th scope="col"></th>
							...
							<tr>
								...
								<th scope="col">
									<select name="etin_filter3[]" id="etin_filter3" class="form-control select2" multiple>
										<option value="">Select</option>
										<?php $__currentLoopData = $getet3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_etin3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($row_etin3); ?>"><?php echo e($row_etin3); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								<th scope="col">
									<select  id="listing_name_filter3" name="listing_name_filter3[]" class="form-control select2" multiple>
										<option value=''>Select</option>
										<?php $__currentLoopData = $listing_name3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ln): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($ln); ?>"><?php echo e($ln); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								...
								<th scope="col">
									<select id="upc_filter3" name="upc_filter3[]" class="form-control select2" multiple>
										<option value=''>Select</option>
										<?php $__currentLoopData = $upcs3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upc3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($upc3); ?>"><?php echo e($upc3); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								<th scope="col">
							...
							<tr>
								<th scope="col">
									<select name="etin_filter4[]" id="etin_filter4" class="form-control select2" multiple>
										<!-- <option value="">Select</option> -->
										<?php $__currentLoopData = $getet4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_etin4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($row_etin4); ?>"><?php echo e($row_etin4); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								<th scope="col">
									<select  id="listing_name_filter4" name="listing_name_filter4[]" class="form-control select2" multiple>
										<option value=''>Select</option>
										<?php $__currentLoopData = $listing_name4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ln): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($ln); ?>"><?php echo e($ln); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								...
								<th scope="col">
									<select id="upc_filter4" name="upc_filter4[]" class="form-control select2" multiple>
										<!-- <option value=''>Select</option> -->
										<?php $__currentLoopData = $upcs4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upc4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($upc4); ?>"><?php echo e($upc4); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</th>
								<th scope="col">
...
<script type="text/javascript">
	...
	function GetActiveProducts(){
		var table = $('#datatable').DataTable({
            ...
            autoWidth: false,
			ajax:{
                    url: '<?php echo e(route('getmasterproducts')); ?>',
                    method:'GET',
                    data: {
	...
	function GetNotApprovedProduct(){
		var table = $('#datatablenotapproved').DataTable({
            ...
            autoWidth: false,
			ajax:{
                    url: '<?php echo e(route('getnotapprovedmasterproducts')); ?>',
                    method:'GET',
                    data: {
	...
	function GetEditedProducts(){
		var table = $('#datatableedited').DataTable({
            ...
            autoWidth: false,
			ajax:{
                    url: '<?php echo e(route('geteditedmasterproducts')); ?>',
                    method:'GET',
                    data: {
	...
	function GetDraftProducts(){
		var table = $('#datatableadded').DataTable({
            ...
            autoWidth: false,
			ajax:{
                    url: '<?php echo e(route('getaddedmasterproducts')); ?>',
                    method:'GET',
                    data: {
	...
	$('#newApprove').click(function(){
		...
		if(val.length !== 0){
			if(confirm("Are You Sure To Approve Selected Products ?")){
				$.ajax({
					type: "POST",
					url: '<?php echo e(route('approveNewProducts')); ?>',
					data: {
						checked : val,
					},
	...
	$('#editApprove').click(function(){
		...
		if(val.length !== 0){
			if(confirm("Are You Sure To Approve Selected Products ?")){
				$.ajax({
					type: "POST",
					url: '<?php echo e(route('approveEditProducts')); ?>',
					data: {
						checked : val,
					},
					success: function( response ) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/cranium/allmasterproductlists.blade.php ENDPATH**/ ?>