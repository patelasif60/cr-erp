                            ...
                            <div class="col-md-3">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input required value='<?php echo e($packagingMatirials->quantity_per_bundle); ?>' type="text" class="form-control" id="quantity_per_bundle" name="quantity_per_bundle" placeholder="Enter Quantity Per Bundle">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="address" class="ul-form__label">Bundle Qty Per Truck Load<span class="text-danger">*</span></label>
                                        <input required type="text" value='<?php echo e($packagingMatirials->bundle_qty_per_truck_load); ?>' class="form-control" id="bundle_qty_per_truck_load" name="bundle_qty_per_truck_load" placeholder="Enter Bundle Qty Per Truck Load">
                                    </div>
                                    <div class="form-group col-md-12">
	                                    ...
	                                    <select class="form-control select2" id="product_temperature" name="product_temperature">
	                                        <option value="">--Select--</option>
                                            <option value="Packaging" <?php echo e($packagingMatirials->product_temperature == "Packaging" ? 'selected' : ''); ?>>Packaging</option>
	                                        <?php if($producttemp): ?>
                                        ...
                                        <select class="form-control select2" id="client_assigned" name="clients_assigned" onchange="fetchChannelAndProduct(this.value)">
                                            ...
                                            <?php if($client): ?>
                                                <?php $__currentLoopData = $client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>" <?php if($key == $packagingMatirials->clients_assigned) echo 'selected';?> ><?php echo e($value); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>                                        
                                        </select>
                                    </div>	                            	                            
                            ...
                            <div class="col-md-3">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control" id="status" name="status" >
                                        <option <?php echo e($packagingMatirials->status == 'Active' ? 'selected' : ''); ?> value="Active">Active</option>
                                        <option <?php echo e($packagingMatirials->status == 'Inactive' ? 'selected' : ''); ?> value="Inactive">Inactive</option>
                                        <option <?php echo e($packagingMatirials->status == 'Secondary' ? 'selected' : ''); ?> value="Secondary">Secondary</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" value='<?php echo e($packagingMatirials->acquisition_cost); ?>' name="acquisition_cost" id="acquisition_cost" class="form-control" placeholder="Enter Acquisition Cost">
                                </div>
                                <div class="form-group col-md-12">
                                        ...
                                        <?php if($warehouse): ?>
											<?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr>
													...
													<td>
														<input type="checkbox" calss="js-warehouseval" name="warehouse[]" value="<?php echo e($warehouses); ?>" 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/suppliers/packaging_material/edit.blade.php ENDPATH**/ ?>