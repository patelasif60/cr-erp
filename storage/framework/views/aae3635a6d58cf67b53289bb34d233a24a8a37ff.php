                                        ...
                                        <?php if($warehouse): ?>
											<?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr>
													...
													<td><input type="checkbox" name="warehouse[]" value="<?php echo e($warehouses); ?>"></td>
													<td></td>
												</tr>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
...
$("#packaging_material_add_form").validate({
    ...
    getSupplierPackaging = () =>  {
            ...
            autoWidth: false,
            ajax:{
                    url: '<?php echo e(route('getpackagingbysupplier',$supplier->id)); ?>',
                    method:'GET',
                    data: function(d){
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/cranium/kitpackaging/create.blade.php ENDPATH**/ ?>