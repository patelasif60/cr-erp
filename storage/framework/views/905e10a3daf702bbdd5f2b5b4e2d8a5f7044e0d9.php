                                    ...
                                    <select class="form-control" id="warehouse_id" name="warehouse" onchange="getProductList()">
                                        ...
                                        <?php if($warehouses): ?>
                                            <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                       
                                                <option value="<?php echo e($warehouse->id); ?>"><?php echo e($warehouse->warehouses); ?></option>
       ...
       $(document).ready(function () {
        ...
        function PurchaseOrderProducts(warehouseId) {
            table1 = $('#purchase_order_products').DataTable({
                ...
                ajax:{
                        url: '<?php echo e(route('datatable.PurchaseOrderProducts')); ?>',
                        method: 'GET',
                        data: function(d) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/purchase_order/create.blade.php ENDPATH**/ ?>