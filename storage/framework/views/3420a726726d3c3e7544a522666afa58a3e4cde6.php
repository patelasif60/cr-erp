...
<?php if($productdetails->is_approve == 0): ?>
<div class="row mb-3">
	<div class="col-md-6">
		<?php if($prevProductId != NULL): ?>
			<div class="btn btn-primary btn-icon m-1"  style="float: left; text-align: right;">
				...
				<a href="<?php echo e(url('editmasterproduct/'.$prevProductId)); ?>" class="ul-btn__text" style="color:#fff;"> Previous </a>
			</div>
	...
	<div class="col-md-6">
		...
		<div class="btn btn-primary btn-icon m-1"  style="float: right; text-align: right;">
			<a href="<?php echo e(url('editmasterproduct/'.$nextProductId)); ?>" class="ul-btn__text" style="color:#fff;"> Next </a>
...
<div class="card-header bg-transparent">
		...
		<?php if(ReadWriteAccess('EditMasterProductDuplicateProduct')): ?>
		<div class="btn btn-danger btn-icon m-1"  style="float: right; text-align: right;">
			...
			<a href="<?php echo e(url('duplicateproduct/'.$productdetails->id)); ?>" class="ul-btn__text" style="color:#fff;"> Duplicate Product </a>
		</div>

		<?php endif; ?>
		<?php if(ReadWriteAccess('EditMasterProductAddChildProduct')): ?>
		<div class="btn btn-primary btn-icon m-1"  style="float: right; text-align: right;">
			<span class="ul-btn__icon"><i class="i-Add"></i></span>
			<a href="<?php echo e(url('childproduct/'.$productdetails->id)); ?>" class="ul-btn__text" style="color:#fff;"> Add Child Product </a>
		</div>
		<?php endif; ?>
		<?php else: ?>
		...
		<?php endif; ?>
		<?php if($product_request_details): ?>
		<?php if(ReadWriteAccess('EditMasterProductProductEditRequest')): ?>
		<div class="btn btn-warning btn-icon m-1"  style="float: right; text-align: right;">
			<span class="ul-btn__icon"><i class="i-Pen-2"></i></span>
			<a href="<?php echo e(url('editmasterrequestview/'.$product_request_details->id)); ?>" class="ul-btn__text" style="color:black;"> Product Edit Request </a>
		</div>
		<?php endif; ?>
		<?php endif; ?>
...
<!--begin::form-->
<?php if($productdetails->is_approve == 0): ?>
		<?php if(ReadWriteAccess('NewProductsPendingApprovalClickHeretoApprove')): ?>
...
<!--begin::form-->
<form method="POST" action="<?php echo e(route('updatemasterproduct')); ?>" enctype="multipart/form-data" id="product_add">
			...
			<div class="row col-lg-12">
				<div class="col-lg-8">
					...
					<div class="form-group col-md-6">
						...
						<select id="status" name="status" class="form-control select2 <?php if(isset($producthistory)){ if($producthistory->status != $productdetails->status) echo "edited-field";}?> <?php if(ProductEditPermission('status') == 0): ?> custom_readonly <?php endif; ?>" >
					...
					<div class="form-group col-md-6">
						...
						<select id="etailer_availability" name="etailer_availability" class="form-control select2 <?php if(isset($producthistory)){ if($producthistory->etailer_availability != $productdetails->etailer_availability) echo "edited-field";}?> <?php if(ProductEditPermission('etailer_availability') == 0): ?> custom_readonly <?php endif; ?>" id="etailer_availability" >
								<option value=''> -- Select a value  -- </option>
								<?php if($etailers): ?>
				...
				<div class="col-lg-4">
					<div class="form-group">
						...
						<table class="table table-bordered">
							...
							<?php if($warehouse): ?>
								<?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$warehouses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td><?php echo e($onHandQty[$key]); ?></td>
										<td><?php echo e($AvailQty[$key]); ?></td>
									</tr>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
						</table>
						...
						<div class="row mt-4">
							<div class="col-md-3">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control <?php if(isset($producthistory)){ if($producthistory->flavor != $productdetails->flavor) echo "edited-field";}?> <?php if(ProductEditPermission('flavor') == 0): ?> custom_readonly <?php endif; ?>" id="flavor" name="flavor" placeholder="Flavor Variation" value="<?php echo e($productdetails->flavor); ?>">
								</div>
								<div class="form-group col-md-12">
									...
									<select id="product_type" name="product_type" class="form-control select2 <?php if(isset($producthistory)){ if($producthistory->product_type != $productdetails->product_type) echo "edited-field";}?> <?php if(ProductEditPermission('product_type') == 0): ?> custom_readonly <?php endif; ?>" id="product_type" >
										<option value=''> -- Select a value  -- </option>
										<?php if($producttype): ?>
								...
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control <?php if(isset($producthistory)){ if($producthistory->pack_form_count != $productdetails->pack_form_count) echo "edited-field";}?> " id="pack_form_count" name="pack_form_count" placeholder="Pack Form Count" min="1" value="<?php echo e($productdetails->pack_form_count); ?>"  <?php if(ProductEditPermission('pack_form_count') == 0): ?> readonly <?php endif; ?>>
								</div>
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control <?php if(isset($producthistory)){ if($producthistory->unit_in_pack != $productdetails->unit_in_pack) echo "edited-field";}?> " id="unit_in_pack" name="unit_in_pack" placeholder="Units in Pack" min="1" value="<?php echo e($productdetails->unit_in_pack); ?>"  <?php if(ProductEditPermission('unit_in_pack') == 0): ?> readonly <?php endif; ?>>
								</div>
								<div class="form-group col-md-12">
									...
									<select id="unit_description" name="unit_description" class="form-control select2 <?php if(isset($producthistory)){ if($producthistory->unit_description != $productdetails->unit_description) echo "edited-field";}?> <?php if(ProductEditPermission('unit_description') == 0): ?> custom_readonly <?php endif; ?>"  >
										<option value=''> -- Select a value  -- </option>
										<?php if($unitdesc): ?>
							...
							<div class="col-md-3">
									...
									<table class="table ">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->weight != $productdetails->weight) echo "edited-field";}?> <?php if(ProductEditPermission('weight') == 0): ?> custom_readonly <?php endif; ?>" id="weight" name="weight" placeholder="Weight (lbs)" value="<?php echo e($productdetails->weight); ?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->length != $productdetails->length) echo "edited-field";}?> <?php if(ProductEditPermission('length') == 0): ?> custom_readonly <?php endif; ?>" id="length" name="length" placeholder="Length (in)" value="<?php echo e($productdetails->length); ?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->width != $productdetails->width) echo "edited-field";}?> <?php if(ProductEditPermission('width') == 0): ?> custom_readonly <?php endif; ?>" id="width" name="width" placeholder="Width (in)" value="<?php echo e($productdetails->width); ?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->height != $productdetails->height) echo "edited-field";}?> <?php if(ProductEditPermission('height') == 0): ?> custom_readonly <?php endif; ?>" id="height" name="height" placeholder="Height (in)" value="<?php echo e($productdetails->height); ?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
										</tbody>
									</table>
									...
									<div class="row">
										<div class="col-md-6">
											...
											if(isset($producthistory)){
												...
												if($productdetails->unit_num != $unit_num) echo "edited-field";}?>"  value="<?php echo e($productdetails->unit_num); ?>" placeholder="Select Unit Count"  min="0.0001" step="0.0001" pattern="^\d+(?:\.\d{1,4})?$"  <?php if(ProductEditPermission('unit_num') == 0): ?> readonly <?php endif; ?>">
										</div>
										<div class="col-md-6">
											<select id="unit_list" name="unit_list" class="form-control <?php
											 ...
											 if(isset($producthistory)){
												...
												if($productdetails->unit_list != $unit_list) echo "edited-field";}?>" id="unit_list"  <?php if(ProductEditPermission('unit_list') == 0): ?> readonly <?php endif; ?>>
								...
								<div class="form-group col-md-12">
									...
									<select id="item_form_description" name="item_form_description" class="form-control select2 <?php if(isset($producthistory)){ if($producthistory->item_form_description != $productdetails->item_form_description) echo "edited-field";}?> <?php if(ProductEditPermission('item_form_description') == 0): ?> custom_readonly <?php endif; ?>" id="item_form_description" >
										<option value=''> -- Select a value  -- </option>
										<?php if($itemsdesc): ?>
									...
									<table class="table ">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->weight != $productdetails->weight) echo "edited-field";}?> <?php if(ProductEditPermission('weight') == 0): ?> custom_readonly <?php endif; ?>" id="unit_weight" name="unit_weight" placeholder="Weight (lbs)" value="<?php if(isset($suplimental_data->weight)) { echo $suplimental_data->weight; }?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Length of the item/unit in inches (in)">Length (in) </td>
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->length != $productdetails->length) echo "edited-field";}?> <?php if(ProductEditPermission('length') == 0): ?> custom_readonly <?php endif; ?>" id="unit_length" name="unit_length" placeholder="Length (in)" value="<?php if(isset($suplimental_data->length)) { echo $suplimental_data->length; }?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Width (depth)of the item/unit in inches (in)">Width (in) </td>
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->width != $productdetails->width) echo "edited-field";}?> <?php if(ProductEditPermission('width') == 0): ?> custom_readonly <?php endif; ?>" id="unit_width" name="unit_width" placeholder="Width (in)" value="<?php if(isset($suplimental_data->width)) { echo $suplimental_data->width; }?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Height of the item/unit in inches (in)">Height (in) </td>
												<td>
													<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->height != $productdetails->height) echo "edited-field";}?> <?php if(ProductEditPermission('height') == 0): ?> custom_readonly <?php endif; ?>" id="unit_height" name="unit_height" placeholder="Height (in)" value="<?php if(isset($suplimental_data->height)) { echo $suplimental_data->height; }?>"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" >
												</td>
											</tr>
										</tbody>
									</table>
									...
									<table class="table ">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="form-group col-md-12">
														<select id="prop_65_flag" name="prop_65_flag" class="form-control <?php if(isset($producthistory)){ if($producthistory->prop_65_flag != $productdetails->prop_65_flag) echo "edited-field";}?> <?php if(ProductEditPermission('prop_65_flag') == 0): ?> custom_readonly <?php endif; ?>" id="prop_65_flag">
															<option value=''> -- Select a value  -- </option>
											...
											<tr>
												...
												<td>
													<select class="form-control <?php if(isset($producthistory)){ if($producthistory->hazardous_materials != $productdetails->hazardous_materials) echo "edited-field";}?> <?php if(ProductEditPermission('hazardous_materials') == 0): ?> custom_readonly <?php endif; ?>" id="hazardous_materials" name="hazardous_materials">
														<option value=""> -- Select a value -- </option>
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control <?php if(isset($producthistory)){ if($producthistory->full_product_desc != $productdetails->full_product_desc) echo "edited-field";}?> <?php if(ProductEditPermission('full_product_desc') == 0): ?> custom_readonly <?php endif; ?>" id="full_product_desc" name="full_product_desc" placeholder="Full Product Descrtiption" value="<?php echo e($productdetails->full_product_desc); ?>" >
								</div>
								<div class="form-group col-md-12">
									...
									<table class="table ">
										<tbody>
											...
											<tr>
												...
												<td>
													<select class="form-control <?php if(isset($producthistory)){ if($producthistory->dropship_available != $productdetails->dropship_available) echo "edited-field";}?> <?php if(ProductEditPermission('dropship_available') == 0): ?> custom_readonly <?php endif; ?>" id="dropship_available" name="dropship_available">
														<option value="">--Select a value--</option>
											...
											<tr>
												...
												<td>
													<?php if($productdetails->is_approve == 1): ?>
														<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->cost != $productdetails->cost) echo "edited-field";}?> <?php if(ProductEditPermission('cost') == 0): ?> custom_readonly <?php endif; ?>" placeholder="Cost" id="cost" name="cost" value="<?php echo e($productdetails->cost); ?>" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$">
													<?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($productdetails->is_approve == 1): ?>
														<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->acquisition_cost != $productdetails->acquisition_cost) echo "edited-field";}?> <?php if(ProductEditPermission('acquisition_cost') == 0): ?> custom_readonly <?php endif; ?>" placeholder="acquisition_cost" id="Acquisition Cost" name="acquisition_cost" value="<?php echo e($productdetails->acquisition_cost); ?>" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$">
													<?php else: ?>

														<input type="number" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->acquisition_cost != $productdetails->acquisition_cost) echo "edited-field";}?>" placeholder="Aquisition Cost" id="acquisition_cost" name="acquisition_cost" value="<?php echo e($productdetails->acquisition_cost); ?>" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" >
													<?php endif; ?>
                                                </td>
                                            </tr>
											<tr>
											...
											<tr>
												...
												<td><input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->week_worth_qty != $productdetails->week_worth_qty) echo "edited-field";}?>" id="week_worth_qty" name="week_worth_qty" placeholder="Weeks Worth Qantity" value="<?php echo e($productdetails->week_worth_qty); ?>"></td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Minimum Order Qantity">
													Minimum Order Qantity
												</td>
												<td><input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->min_order_qty != $productdetails->min_order_qty) echo "edited-field";}?>" id="min_order_qty" name="min_order_qty" placeholder="Minimum Order Qantity" value="<?php echo e($productdetails->min_order_qty); ?>"></td>
											</tr>
											<tr>
												<td scope="row" data-toggle="tooltip" data-placement="top" title="Lead Time">
													Lead Time
												</td>
												<td><input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->lead_time != $productdetails->lead_time) echo "edited-field";}?>" id="lead_time" name="lead_time" placeholder="Lead Time" value="<?php echo e($productdetails->lead_time); ?>"></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<table class="table card_">
									...
									<tbody>
										<tr>
											...
											<td>
												<input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->supplier_product_number != $productdetails->supplier_product_number) echo "edited-field";}?> <?php if(ProductEditPermission('supplier_product_number') == 0): ?> custom_readonly <?php endif; ?>" placeholder="Supplier Product Number" id="supplier_product_number" name="supplier_product_number" value="<?php echo e($productdetails->supplier_product_number); ?>">
											</td>
										</tr>
										<tr>
											<td scope="row" data-toggle="tooltip" data-placement="top" title="Manufacturer's product number">Manufacturer Product Number</td>
											<td>
												<input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->manufacture_product_number != $productdetails->manufacture_product_number) echo "edited-field";}?> <?php if(ProductEditPermission('manufacture_product_number') == 0): ?> custom_readonly <?php endif; ?>" placeholder="Manufacturer Product Number" id="manufacture_product_number" name="manufacture_product_number" value="<?php echo e($productdetails->manufacture_product_number); ?>">
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control text-center <?php if(isset($producthistory)){ if($producthistory->GPC_code != $productdetails->GPC_code) echo "edited-field";}?> <?php if(ProductEditPermission('asin') == 0): ?> custom_readonly <?php endif; ?>"" id="GPC_code" name="GPC_code" placeholder="GPC Code" value="<?php echo e($productdetails->GPC_code); ?>">
											</td>
										</tr>
										<tr>
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control <?php if(isset($producthistory)){ if($producthistory->MFG_shelf_life != $productdetails->MFG_shelf_life) echo "edited-field";}?> <?php if(ProductEditPermission('MFG_shelf_life') == 0): ?> custom_readonly <?php endif; ?>" id="MFG_shelf_life" name="MFG_shelf_life" placeholder="MFG Shelf Life" value="<?php echo e($productdetails->MFG_shelf_life); ?>" min="1" max="99999" >
								</div>
								<div class="form-group col-md-12">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control <?php if(isset($producthistory)){ if($producthistory->ingredients != $productdetails->ingredients) echo "edited-field";}?> <?php if(ProductEditPermission('ingredients') == 0): ?> custom_readonly <?php endif; ?>" id="ingredients" name="ingredients" placeholder="Ingredients" value="<?php echo e($productdetails->ingredients); ?>">
								</div>
										...
										<?php if($allergens): ?>
											<?php $__currentLoopData = $allergens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row_allergens): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php if(!in_array($key,$allergens_assigned)): ?>
													<div class="allergens_cards custom_one_line_cards <?php if(ProductEditPermission('allergens') == 0): ?> custom_readonly <?php endif; ?> <?php if(isset($producthistory)){ if($producthistory->allergens != $productdetails->allergens) echo "edited-field";}?>" id="<?php echo e($key); ?>"><?php echo e($row_allergens); ?></div>
												<?php endif; ?>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
									</div>
...
var table = $('#product_history_table').DataTable({
	...
	autoWidth: false,
	ajax:{
		url: '<?php echo e(route('getProductHistory',$productdetails->id)); ?>',
		method:'GET',
	},
	columns: [
		// {data: 'id', name: 'ID'},
...
// 		autoWidth: false,
// 		ajax:{
// 			url: '<?php echo e(route('datatable.ProductTicketsList',[$productdetails->id,"master_product"])); ?>',
// 			method:'GET',
// 		},
// 		columns: [
// 			// {data: 'id', name: 'ID'},
...
// 	 var name = $(this).val();
// 	 var myurl1 = "<?php echo e(url('getbrand')); ?>" +"/"+ name;
// 	 var token = "<?php echo e(csrf_token()); ?>";
...
$(document).ready(function(){
	...
	submitHandler(form){
		...
		$.ajax({
			type: "POST",
			url: '<?php echo e(route('updatemasterproduct')); ?>',
			data: form1,
			processData: false,
			contentType: false,
			success: function( response ) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/cranium/supplierProdListing/masterproductedit.blade.php ENDPATH**/ ?>