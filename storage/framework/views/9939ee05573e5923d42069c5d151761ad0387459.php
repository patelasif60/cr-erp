    ...
    <div class="form-group col-2">
        ...
        <select id="warehouses" name="warehouses" class="form-control select2" >
             <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($warehouse->warehouses); ?>" <?php if(isset($cc_sum)){ if($cc_sum->warehouse_id == $warehouse->id) echo "selected";}?> ><?php echo e($warehouse->warehouses); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="form-group col-2">
        <label class="ul-form__label">Schedule Date</label>
        <input type="date" class="form-control" id="schedule_date" name="schedule_date" value="<?php echo e($cc_sum->scheduled_date); ?>">
    </div>
    <div class="form-group col-2">
     ...
     <div class="col-2 js-client">
        ...
        <select name="client_id" id="client_id"  class="form-control select2">
            ...
            <?php $__currentLoopData = $client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_c => $row_c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option <?php echo e($cc_sum->client_id == $key_c ? 'selected':''); ?>  value="<?php echo e($key_c); ?>"><?php echo e($row_c); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="col-2">
        ...
        <select name="user_id" id="user_id"  class="form-control select2">
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_c => $row_c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option <?php echo e($cc_sum->user_id == $key_c ? 'selected':''); ?> value="<?php echo e($key_c); ?>"><?php echo e($row_c); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="col-12">
                    ...
                    <table id="datatable" class="table table-bordered text-center dataTable_filter">
                        <thead>
                            <tr>
                                ...
                                <?php if($product_listing_filter): ?>
                                    <?php $__currentLoopData = $product_listing_filter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row_product_listing_filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if((!empty($visible_filters) && in_array($row_product_listing_filter->sorting_order,$visible_columns)) || ($id == NULL && $row_product_listing_filter->is_default == 1)): ?>
...
function showAdvanceFilterDiv(div_id){
        ...
        if($("#countBy").val() == 'location'){
            ...
            ajax:{
                    ...
                    data: function(d) {
                        ...
                        d['cc_sum_id'] = '<?php echo e(isset($cc_sum) ? $cc_sum->id : ''); ?>';
            ...
            table1 = $('#datatable1').DataTable({
                ...
                ajax:{
                        ...
                        data: {
                                ...
                                countBy : $("#countBy").val(),
                                cc_sum_id : '<?php echo e(isset($cc_sum) ? $cc_sum->id : ''); ?>'
    ...
    function GetWarehouseApprovedProducts(){
         ...
         table1 = $('#datatable2').DataTable({
            ...
            searching:true,
            ajax:{
                    url: '<?php echo e(route('locationapprovedproducts')); ?>',
                    method:'POST',
                    data: {
                        warehouse: $("#warehouses").val(),
                        cc_sum_id: '<?php echo e(isset($cc_sum) ? $cc_sum->id : ''); ?>'
    ...
    function SaveSummary(){
        ...
        var sumId = '<?php echo e(isset($cc_sum) ? $cc_sum->id : ''); ?>';

        if (sumId && sumId !== '' && sumId !== undefined) {
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('update_summary')); ?>',
                data: {
                    new_date: newDate,
                    cc_sum_id: sumId
                },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/WarehouseManagment/cyclecountedit.blade.php ENDPATH**/ ?>