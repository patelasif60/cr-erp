			...
			<div class="card-body">
				...
				<div class="mb-3 row" style="">
                    ...
                    <div class="col-md-2 mb-4 js-fromdate d-none">
                        ...
                        <input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="from_date" name="from_date">
                    </div>
                    <div class="col-md-2 mb-4 js-todate d-none">
                        <label class="ul-form__label">To Date</label>
                        <input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="to_date" name="to_date">
                    </div>
                    ...
                    <div class="col-md-2 mb-4">
                        ...
                        <select class="form-control select2" id="warehouseId" name="warehouseId">
                            ...
                            <?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouseKey=>$warehouseVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($warehouseVal->warehouses); ?>"><?php echo e($warehouseVal->warehouses); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                        ...
                        <ul class="" id="#column_visibility"  style="list-style-type:none;">
                            <?php if($product_listing_filter): ?>
                                <?php $__currentLoopData = $product_listing_filter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row_product_listing_filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="m-2">
                                        <label for="hide_show_column_<?php echo e($row_product_listing_filter->id); ?>">
                                            <input  id="hide_show_column_<?php echo e($row_product_listing_filter->id); ?>" class="listing-filter-columns" type="checkbox" name='columns[]' value="<?php echo e($row_product_listing_filter->column_name); ?>" <?php echo e(!empty($visible_filters) && in_array($row_product_listing_filter->sorting_order,$visible_columns) || ($row_product_listing_filter->is_default == 1) ? 'checked' : ''); ?> <?php if(!empty($visible_filters) && in_array($row_product_listing_filter->sorting_order,$visible_columns) || ($row_product_listing_filter->is_default == 1)) { ?> onclick="return false"<?php } ?>>
                                            <span class="font-weight-bold ml-2"><?php echo e($row_product_listing_filter->label_name); ?></span>
                                        </label>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/cranium/reports/reportbuilder/index.blade.php ENDPATH**/ ?>