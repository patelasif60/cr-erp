			...
			<div class="row col-lg-12">
				<div class="col-lg-8">
					<div class="form-group col-md-12">
						...
						<input type="text" class="form-control" id="product_listing_name" name="product_listing_name" placeholder="Product Listing Name" value="<?php echo e($row->product_listing_name); ?>" readonly>

					</div>
					<div class="form-group col-md-6">
						<label for="ETIN" class="ul-form__label" data-toggle="tooltip" data-placement="top" title="e-tailer internal SKU">ETIN</label>
						<input type="text" class="form-control" id="ETIN" placeholder="ETIN" name ="ETIN" value='<?php echo e($row->ETIN); ?>' readonly>
					</div>
					<div class="form-group col-md-6">
						...
						<select id="status" name="status" class="form-control select2" >
							...
							<?php if($product_status): ?>
								<?php $__currentLoopData = $product_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($row_status->product_status); ?>" <?php if($row->status == $row_status->product_status ) echo "selected";?>><?php echo e($row_status->product_status); ?></option>
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" id="parent_ETIN" placeholder="Parent ETIN" name ="parent_ETIN" readonly value='<?php echo e($row->parent_ETIN); ?>'>
					</div>
					<div class="form-group col-md-6">
						...
						<select id="etailer_availability" name="etailer_availability" class="form-control select2" id="etailer_availability" >
								...
								<?php if($etailers): ?>
									<?php $__currentLoopData = $etailers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$etailer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($key); ?>" <?php if($row->etailer_availability == $key ) echo "selected";?>><?php echo e($etailer); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" id="alternate_ETINs" placeholder="Alternate ETINs" name ="alternate_ETINs" value='<?php echo e($row->alternate_ETINs); ?>'>
					</div>
					<div class="form-group col-md-6">
						...
						<select id="product_temperature" name="product_temperature" class="form-control select2" id="product_temperature" >
							...
							<?php if($producttemp): ?>
								<?php $__currentLoopData = $producttemp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producttemplist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($producttemplist); ?>" <?php if($row->product_temperature == $producttemplist ) echo "selected";?>><?php echo e($producttemplist); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
						</select>
					</div>
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" id="product_listing_ETIN" name="product_listing_ETIN" placeholder="Product listing ETIN" value='<?php echo e($row->product_listing_ETIN); ?>'>
					</div>
				</div>
				<div class="col-lg-4">
							...
							<?php if($warehouse): ?>
								<?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td><?php echo e($onHandQty[$warehouses]); ?></td>
									</tr>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
						</table>
					...
					<div class="tab-pane fade show active" id="tab_product_detail" role="tabpanel" area-labelledby="product_detail_tab">
						<div class="row mt-4">
							...
							<div class="col-lg-5">
								...
								<input type="hidden" id="selected_products" value="<?php echo e($selected_products); ?>">
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="flavor" name="flavor" placeholder="Flavor Variation" value='<?php echo e($row->flavor); ?>'>
								</div>
								<div class="form-group col-md-12">
									...
									<select id="product_type" name="product_type" class="form-control select2" >
										...
										<?php if($producttype): ?>
											<?php $__currentLoopData = $producttype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producttypelist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($producttypelist); ?>" <?php if($row->product_type == $producttypelist ) echo "selected";?>><?php echo e($producttypelist); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
									</select>
								</div>
								...
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control" id="cost" name="cost" placeholder="Cost" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" value="<?php echo e($row->cost); ?>">
								</div>
                                ...
                                <div class="form-group col-md-12">
									...
									<input type="number" class="form-control" id="acquisition_cost" name="acquisition_cost" placeholder="Acquisition Cost" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" value="<?php echo e($row->acquisition_cost); ?>">
								</div>
								...
								<div class="form-group col-md-12">
									...
									<input type="number" class="form-control" id="new_cost" name="new_cost" placeholder="New Cost" min="0.01" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" value="<?php echo e($row->new_cost); ?>">
								</div>
								...
								<div class="form-group col-md-12">
									...
									<input type="date" class="form-control" id="new_cost_date" name="new_cost_date" placeholder="New Cost Date" value="<?php echo e($row->new_cost_date); ?>">
								</div>
							</div>
							<div class="col-md-4">
									...
									<table class="table ">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center" id="weight" name="weight" placeholder="Weight (lbs)"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$" value="<?php echo e($row->weight); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center" id="length" name="length" placeholder="Length (in)"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  value="<?php echo e($row->length); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center" id="width" name="width" placeholder="Width (in)"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  value="<?php echo e($row->width); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="number" class="form-control text-center" id="height" name="height" placeholder="Height (in)"  min="0.001" step="0.001" pattern="^\d+(?:\.\d{1,3})?$"  value="<?php echo e($row->height); ?>">
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="row mt-4">
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="full_product_desc" name="full_product_desc" placeholder="Full Product Descrtiption" value="<?php echo e($row->full_product_desc); ?>">
								</div>
								<div class="form-group col-md-12">
									...
									<select id="product_category" name="product_category" class="form-control select2 all_product_category <?php if(isset($producthistory)){ if($producthistory->product_category != $productdetails->product_category) echo "edited-field";}?> <?php if(ProductEditPermission('product_category') == 0): ?> custom_readonly <?php endif; ?>" id="product_category"  data-id='0'>
										...
										<?php if($categories): ?>
											<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($row_cat->id); ?>" <?php if($row->product_category == $row_cat->id ) echo "selected";?>><?php echo e($row_cat->name); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
									</select>
								</div>
									...
									<?php for($i=1; $i<=9;$i++): ?>
										...
										<?php if($row->$name != ''): ?>
											<div class="form-group col-md-12">
												...
												<select id="<?php echo e($row->$name); ?>" name="<?php echo e($row->$name); ?>" class="form-control select2 <?php if(isset($producthistory)){ if($producthistory->$name != $row->$name) echo "edited-field";}?> <?php if(ProductEditPermission($name) == 0): ?> custom_readonly <?php endif; ?>" id="<?php echo e($name); ?>" >
													<option value="">Select</option>
													<option value='<?php echo e($row->$name); ?>' selected> <?php echo e(CategoryName($row->$name)); ?> </option>
												</select>
											</div>
							...
							<!-- <div class="form-group col-md-12">
								...
								<div class="form-group col-md-6">
									<input type="hidden" name="product_tags" id="product_tags" value="<?php echo e($row->product_tags); ?>">
									...
									<table class="table">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" placeholder="Supplier Product Number" id="supplier_product_number" name="supplier_product_number" value="<?php echo e($row->supplier_product_number); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" placeholder="Manufacturer Product Number" id="manufacture_product_number" name="manufacture_product_number" value="<?php echo e($row->manufacture_product_number); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													...
													<input type="text" class="form-control text-center" id="upc" name="upc" placeholder="UPC" minlength="12" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeypress='validatetext(event)' value="<?php echo e($row->upc); ?>">
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													...
													<input type="text" class="form-control text-center" id="gtin" name="gtin" placeholder="GTIN" minlength="14" maxlength="14" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeypress='validatetext(event)' value="<?php echo e($row->gtin); ?>">
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" id="asin" name="asin" placeholder="ASIN" value="<?php echo e($row->asin); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" id="GPC_code" name="GPC_code" placeholder="GPC Code" value="<?php echo e($row->GPC_code); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" id="GPC_class" name="GPC_class" placeholder="GPC Class" value="<?php echo e($row->GPC_class); ?>">
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="text" class="form-control text-center" id="HS_code" name="HS_code" placeholder="HS Code" value="<?php echo e($row->HS_code); ?>">
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="row mt-4">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<textarea type="text" class="form-control" id="ingredients" name="ingredients" placeholder="Ingredients" value="<?php echo e($row->ingredients); ?>" readonly></textarea>
								</div>
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control"id="storage" name="storage" placeholder="Storage" value="<?php echo e($row->storage); ?>" readonly>
								</div>
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="package_information" name="package_information" placeholder="Package Information" value="<?php echo e($row->package_information); ?>" readonly>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<!-- <input type="text" class="form-control" id="allergens" name="allergens" placeholder="Allergense" value="<?php echo e($row->allergens); ?>" readonly> -->
								</div>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane fade " id="tab_history" role="tabpanel" area-labelledby="history_tab">
						<div class="row">
							...
							<br>
								...
								<!-- <input type="text" class="form-control text-center" id="duplicate_full_product_desc" name="duplicate_full_product_desc" placeholder="Product History" value="<?php echo e($row->full_product_desc); ?>"> -->
					...
					<div class="tab-pane fade " id="tab_clients" role="tabpanel" area-labelledby="clients_tab">
						<div class="row">
							<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									<input type="hidden" name="lobs" id="lobs" value="<?php echo e($row->lobs); ?>">
...
<script>
	$('#ingredients').val("<?php echo e($row->ingredients); ?>");
	...
	var table = $('#product_history_table').DataTable({
		...
		autoWidth: false,
		ajax:{
			url: '<?php echo e(route('getProductHistory',$row->id)); ?>',
			method:'GET',
		},
		columns: [
			// {data: 'id', name: 'ID'},
...
<script>
	$("#product_add").validate({
		submitHandler(form){
			...
			$.ajax({
				type: "POST",
				url: '<?php echo e(route('kits.update',$row->id)); ?>',
				data: form1,
				processData: false,
				contentType: false,
				success: function( response ) {
...
// 		   $.ajax({
// 			type: "GET",
// 			url: "<?php echo e(route('ApproveKit', $row->id)); ?>",
// 			success: function (data) {
// 					location.reload();
// 				}
// 			});
...
// 					   $.ajax({
// 						type: "GET",
// 						url: "<?php echo e(route('deletemasterproduct', $row->id)); ?>",
// 						success: function (data) {
...
// 				}, function (dismiss) {
// 					if (dismiss === 'cancel') {
// 						window.location.href = "<?php echo e(route('kits.edit',$row->id)); ?>";
// 						}
// 					}
// 				)
// 			}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/cranium/kitproducts/edit.blade.php ENDPATH**/ ?>