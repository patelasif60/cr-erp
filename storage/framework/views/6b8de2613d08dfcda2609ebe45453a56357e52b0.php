...
<script>
    function GetWarehouseApprovedProducts(){
        ...
        table1 = $('#datatable2').DataTable({
            ...
            searching:true,
            ajax:{
                    url: '<?php echo e(route('awaitapprovedproducts')); ?>',
                    method:'POST',
                    data: {
...
$('.js-cycle').click(function(){
    ...
    if(val.length !== 0){
        ...
        if(confirm(textmsg)){
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('approveawaitcyclecountproduct')); ?>',
                data: {
                    checked : val,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/WarehouseManagment/cyclecountapproval.blade.php ENDPATH**/ ?>