                                    ...
                                    <table class="table table-bordered" id="warehouses_assigned">
                                        ...
                                        <?php if($warehouse): ?>
                                            <?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <th width="50%" class="text-left"><label for="<?php echo e($warehouses); ?>"><?php echo e($warehouses); ?></label></th>
                                                    <td width="50%" class="text-center"><input type="checkbox" name="warehouses_assigned[]" id="<?php echo e($warehouses); ?>" value="<?php echo e($warehouses); ?>"></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </table>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cranium_new\resources\views/suppliers/create.blade.php ENDPATH**/ ?>