(function ($) {
            ...
            this.each(function () {
                ...
                self.blur = function () {
                     self.$input.on('blur', function (e) {
                        ...
                        var key = e.key;
                        var pasteValue = self.$input.val().trim();
                        var  pasteArray= pasteValue.split(self.KEY_COMMA)
                        $.each( pasteArray, function( key, value ) {
                ...
                self.save = function () {
                    self.$input.on('keyup', function (e) {
                        ...
                        var  pasteArray= value.split(self.KEY_COMMA)
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            ...
            autocomplete_only: 'Please note that you must select a value from the list.',
            timeout: 8000
        }
    };
