...
class CreateMasterProductQueueTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_product_queue', function (Blueprint $table) {
            $table->increments('id');
            $table->string('ETIN');
            ...
            $table->boolean('is_edit')->default(0)->nullable();
    ...
    {
        Schema::dropIfExists('master_product_queue');
    }
}
