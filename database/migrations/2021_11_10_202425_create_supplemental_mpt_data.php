...
class CreateSupplementalMptData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('supplemental_mpt_data', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('supplemental_mpt_data');
    }
}
